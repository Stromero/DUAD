...
product_invoice_bp = Blueprint('product_invoice', __name__)

@product_invoice_bp.route("/product_invoices", methods=["POST"])
@admin_required()
...
@product_invoice_bp.route("/product_invoices/<int:product_invoice_id>", methods=["DELETE"])
@admin_required()
